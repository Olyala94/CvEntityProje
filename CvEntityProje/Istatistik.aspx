...
<link href="cvAdmin/css/style.css" rel="stylesheet" />
<link href="cvAdmin/css/jqvmap.css" rel="stylesheet" />
<script src="cvAdmin/js/Chart1.js"></script>
<script src="cvAdmin/js/jquery.min.js"></script>
<script src="cvAdmin/js/jquery.vmap.js"></script>
<script src="cvAdmin/js/jquery.vmap.sampledata.js"></script>
<script src="cvAdmin/js/jquery.vmap.world.js"></script>
...
<div class="list_of_members">
    ...
    <div class="new-users">
        ...
        <div class="icon-text">
            <h3><asp:Label ID="Label2" runat="server" Text="1"></asp:Label></h3>
...
<div class="total-world">
    ...
    <div class="site-report">
        ...
        <p>CV Sistemi projemizin admin paneli kısmındasınız. Keyifli Kodlamalar dileriz.</p>
    </div>
    <div class="clearfix"></div>
</div>
</asp:Content>
